...
public class ViewHolderForProducts extends RecyclerView.ViewHolder {
    ...
    public ViewHolderForProducts(View itemView) {
        super(itemView);
    ...
    private ViewHolderForProducts.ClickListener mClickListener;
    ...
    public void setOnClickListener(ViewHolderForProducts.ClickListener clickListener){
